...
angular.module('tweadsApp')
  .directive('navLinks', function () {
    return {
      ...
      '<li class="" ng-show="!authenticated"><a title="Sign up to Tweads" href="#/signup">Sign Up</a> </li>' +
      '<li class="" ng-show="authenticated"><a title="Log out of Tweads" ng-click="logout();">Log Out</a></li>' +
      ...
      '<li class="" ng-show="!authenticated"><a title="Log in to Tweads" href="#/login">Log In</a> </li>' +
